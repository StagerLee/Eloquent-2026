    ...
    for attempt in range(retries):
        try:
            ...
            if "429" in msg or "RESOURCE_EXHAUSTED" in msg:
                ...
                print(f"\n🔄 Service unavailable, retrying in {wait}s...")
            else:
...
async def run_file(filename):
    ...
    kept = clean_output_file(output_path)
    if kept > 0:
        print(f"\n🧹 Cleaned output file: kept {kept} valid entries")
